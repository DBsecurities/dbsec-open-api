"""[실시간]K200지수위클리옵션호가 [OB1] — standalone WebSocket 예제.
...
실행:
    ...
    python kr_futopt_realtime/kr_futopt_realtime_k200_weekly_option_orderbook.py
    # examples/kr_futopt_realtime/ 폴더에서 실행하는 경우:
    python kr_futopt_realtime_k200_weekly_option_orderbook.py
