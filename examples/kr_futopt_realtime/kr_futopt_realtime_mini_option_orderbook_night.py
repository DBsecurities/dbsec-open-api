"""[실시간]미니옵션호가(야간) [E11] — standalone WebSocket 예제.
...
실행:
    ...
    python kr_futopt_realtime/kr_futopt_realtime_mini_option_orderbook_night.py
    # examples/kr_futopt_realtime/ 폴더에서 실행하는 경우:
    python kr_futopt_realtime_mini_option_orderbook_night.py
