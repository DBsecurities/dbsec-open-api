"""[실시간]KOSDAQ150옵션체결 [OA0] — standalone WebSocket 예제.
...
실행:
    ...
    python kr_futopt_realtime/kr_futopt_realtime_kosdaq150_option_execution.py
    # examples/kr_futopt_realtime/ 폴더에서 실행하는 경우:
    python kr_futopt_realtime_kosdaq150_option_execution.py
