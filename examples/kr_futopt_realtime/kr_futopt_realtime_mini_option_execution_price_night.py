"""[실시간]미니옵션체결가(야간) [E10] — standalone WebSocket 예제.
...
실행:
    ...
    python kr_futopt_realtime/kr_futopt_realtime_mini_option_execution_price_night.py
    # examples/kr_futopt_realtime/ 폴더에서 실행하는 경우:
    python kr_futopt_realtime_mini_option_execution_price_night.py
...
run_ws(ws_subscribe(
    ...
    tr_cd="E10",  # 거래코드 (str) - TR코드입력: E10
    tr_key="",  # 종목코드 (str) - 미니옵션(야간): EM ※ 종목분류코드 + 미니옵션(야간)종목코드 입력
