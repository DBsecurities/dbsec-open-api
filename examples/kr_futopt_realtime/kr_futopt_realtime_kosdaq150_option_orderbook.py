"""[실시간]KOSDAQ150옵션호가 [OA1] — standalone WebSocket 예제.
...
실행:
    ...
    python kr_futopt_realtime/kr_futopt_realtime_kosdaq150_option_orderbook.py
    # examples/kr_futopt_realtime/ 폴더에서 실행하는 경우:
    python kr_futopt_realtime_kosdaq150_option_orderbook.py
...
run_ws(ws_subscribe(
    ...
    tr_cd="OA1",  # 거래코드 (str) - TR코드입력: OA1
    tr_key="",  # 종목코드 (str) - KOSDAQ150옵션: SO ※ 종목분류코드 + KOSDAQ150옵션 종목코드 입력
