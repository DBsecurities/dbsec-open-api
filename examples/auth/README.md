...
이 격차를 흡수하기 위해 `dbsec_helper.load_cached_token()` 은 **만료 1분 전부터 캐시 토큰을 무효로 간주**하고 새 토큰을 발급받도록 설계되어 있습니다 ([dbsec_helper.py:156](../dbsec_helper.py#L156)). 따라서 정상적인 예제 실행 흐름에서는 이 격차를 신경 쓰지 않아도 됩니다.
