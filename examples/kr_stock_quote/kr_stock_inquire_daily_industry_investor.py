"""일별업종별투자자조회 (UPTJJDAY) — standalone 예제.
...
실행:
    ...
    python kr_stock_quote/kr_stock_inquire_daily_industry_investor.py
    # examples/kr_stock_quote/ 폴더에서 실행하는 경우:
    python kr_stock_inquire_daily_industry_investor.py
...
resp, data = call_rest(
    url="/api/v1/quote/kr-stock/inquiry/daily-investor-u",
    body={
        "In": {
            "InputCondMrktDivCode": "U",  # 입력조건시장분류코드 (str) - 주식&ETF:J 주식(NXT): NJ 주식(통합): UJ ETN: EN ELW: W
            "InputIscd1": "1001",  # 입력종목코드1 (str) - 종목코드 입력 - J(KRX 주식): - NJ(NXT 주식): - UJ(통합): ※ NXT/통합시세로 종목 조회 시 반드시 종목 앞에 구분자 (N-, U-)를 붙여서 호출 부탁드리겠습니다.
            "InputDate1": "20250425",  # 입력날짜1 (str) - YYYYMMDD
            "InputDate2": "20250428",  # 입력날짜2 (str) - YYYYMMDD
        },
    },
    label="일별업종별투자자조회",
)
