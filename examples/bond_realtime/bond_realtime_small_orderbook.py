"""[실시간]소액채권호가 [B11] — standalone WebSocket 예제.
...
실행:
    ...
    python bond_realtime/bond_realtime_small_orderbook.py
    # examples/bond_realtime/ 폴더에서 실행하는 경우:
    python bond_realtime_small_orderbook.py
